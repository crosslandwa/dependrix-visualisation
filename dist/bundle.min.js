(function () {
	...
	*/
	...
	var artifactIds = function artifactIds(state) {
	  return filterBySearchTerms(Object.keys(state.artifacts), state.filters.artifacts);
	};
	...
	var dependencyIds = function dependencyIds(state) {
	  return filterByScope(state, filterBySearchTerms(Object.keys(state.dependencies), state.filters.dependencies));
	};
