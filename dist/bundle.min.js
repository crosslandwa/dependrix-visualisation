(function () {
	...
	*/
	...
	var css = "#app {\n  font-family: sans-serif;\n}\n\n.matrix__table {\n  border-spacing: 0;\n}\n\n.matrix__table-wrapper {\n  width: 100%;\n  overflow: scroll;\n  height: 35em;\n}\n\n.matrix__table-cell {\n  border: solid 1px gray;\n  height: 5em;\n  width: 10em;\n  max-width: 10em;\n  overflow-wrap: break-word;\n  text-align: center;\n}\n\n.matrix__table-lh-column-cell {\n  position: sticky;\n  left: 0;\n  background: white;\n  font-weight: bold;\n  border-right: solid 2px gray;\n}\n\n.matrix__table-header-cell {\n  position: sticky;\n  top: 0;\n  background: white;\n  font-weight: bold;\n  border-bottom: solid 2px gray\n}\n\n.matrix__table-lh-column-cell.matrix__table-header-cell {\n  z-index: 1;\n}\n";
	styleInject(css);
	...
	var dependencyIds = function dependencyIds(state) {
	  return filterBySearchTerms(Object.keys(state.dependencies), state.filters.dependencies);
	};
	...
	var renderDependencyCell = function renderDependencyCell(_ref2) {
	  ...
	  }, version, " (", scope, ")") : react.createElement("td", {
	    "class": "matrix__table-cell"
	  });
	};
	...
	var DependencyMatrix = function DependencyMatrix(_ref3) {
	  ...
	  return react.createElement("div", {
	    ...
	    "class": "matrix__table-cell matrix__table-lh-column-cell matrix__table-header-cell"
	  }), ids.map(function (id) {
	    return react.createElement("td", {
	      "class": "matrix__table-cell matrix__table-header-cell"
	    }, id, " - ", versions[id]);
	  }))), react.createElement("tbody", null, dependencyIds.map(function (dependencyId) {
	    return react.createElement("tr", null, react.createElement("td", {
	      "class": "matrix__table-cell matrix__table-lh-column-cell"
	...
	var App = function App(props) {
	  return react.createElement(react.Fragment, null, react.createElement("h1", null, "Dependrix"), react.createElement(ArtifactFilter$1, null), react.createElement(DependencyFilter$1, null), react.createElement(LoadSummary$1, null), react.createElement(DependencyMatrix$1, null));
	};

	var App$1 = connect(mapStateToProps$2, mapDispatchToProps$2)(App);
