(function () {
	...
	*/
	...
	var useIsomorphicLayoutEffect = typeof window !== 'undefined' ? react_8 : react_7;
	...
	*/
	...
	var filteredDependencyMap = function filteredDependencyMap(state, projectIds) {
	  ...
	  return projectIds.reduce(function (acc, projectId) {
	    return _objectSpread$1({}, acc, _defineProperty$1({}, projectId, projectDependencies(state, projectId).reduce(function (filtered, dependency) {
	      return _objectSpread$1({}, filtered, _defineProperty$1({}, dependency.id, (filtered[dependency.id] || []).concat([dependency].filter(dependencyFilter))));
	    }, {})));
	  }, {});
	};
	  ...
	  switch (action.type) {
	    case 'TREE_LOAD_SUCCESS':
	      return Object.keys(action.data.projects).reduce(function (acc, projectId) {
	        return _objectSpread$1({}, acc, _defineProperty$1({}, projectId, {
	...
	var parseLatestLibraryVersions = function parseLatestLibraryVersions(data) {
	  return Object.keys(data.projects).reduce(function (latestVersions, projectId) {
	    return data.projects[projectId].dependencies.reduce(function (acc, _ref2) {
	      ...
	      return _objectSpread$1({}, acc, _defineProperty$1({}, id, newerOf(acc[id], version)));
	    }, latestVersions);
	  }, {});
	};
