(function () {
	...
	*/
	...
	var App = function App(props) {
	  return react.createElement("h1", null, "Dependrix");
	};

	var App$1 = connect(mapStateToProps, mapDispatchToProps)(App);

	var getSubset_1 = createCommonjsModule(function (module, exports) {
	...
	var createSlicer_1 = createCommonjsModule(function (module, exports) {
	...
	var _getSubsetJs2 = _interopRequireDefault(getSubset_1);



	var _utilTypeOfJs2 = _interopRequireDefault(typeOf_1);
	/**
	 * @description
	...
	unwrapExports(createSlicer_1);

	var mergeState_1 = createCommonjsModule(function (module, exports) {
	...
	unwrapExports(mergeState_1);

	var persistState_1 = createCommonjsModule(function (module, exports) {
	...
	var _createSlicerJs2 = _interopRequireDefault(createSlicer_1);



	var _utilMergeStateJs2 = _interopRequireDefault(mergeState_1);
	/**
	 * @description
	...
	var persistState = unwrapExports(persistState_1);
	...
	var naturalEnhancer = function naturalEnhancer(createStore) {
	  return function () {
	    return createStore.apply(void 0, arguments);
	  };
	};

	var localStorageAvailable = !!(window && window.localStorage);
	var composeEnhancers = window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ || compose;

	function createAppStore() {
	  var middlewares = [];
	  return createStore(reducer, composeEnhancers(applyMiddleware.apply(void 0, middlewares), localStorageAvailable ? persistState() : naturalEnhancer));
	}
