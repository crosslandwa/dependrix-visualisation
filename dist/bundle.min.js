(function () {
	...
	*/
	...
	var renderDependencyCell = function renderDependencyCell(_ref2) {
	  ...
	  return version ? react.createElement("td", null, version, " (", scope, ")") : react.createElement("td", null);
	};
	...
	var DependencyMatrix = function DependencyMatrix(_ref3) {
	  ...
	  return react.createElement("table", null, react.createElement("thead", null, react.createElement("tr", null, react.createElement("td", null), ids.map(function (id) {
	    return react.createElement("td", null, id, " - ", versions[id]);
	  }))), react.createElement("tbody", null, dependencyIds.map(function (dependencyId) {
	    return react.createElement("tr", null, react.createElement("td", null, dependencyId), ids.map(function (id) {
