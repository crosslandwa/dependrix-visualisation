(function () {
	...
	*/
	...
	var mapStateToProps$1 = function mapStateToProps(state) {
	  return apply$1(artifactIds(state), function (ids) {
	    return {
	      ids: ids,
	...
	var mapStateToDependencyCellProps = function mapStateToDependencyCellProps(state, _ref) {
	  var artifactId = _ref.artifactId,
	      dependencyId = _ref.dependencyId;
	  return apply$1(artifactDependencyVersion(state, artifactId, dependencyId), function (version) {
	    return {
	      version: version,
	...
	var renderDependencyCell = function renderDependencyCell(_ref2) {
	...
	var DependencyCell = connect(mapStateToDependencyCellProps)(renderDependencyCell);

	var DependencyMatrix = function DependencyMatrix(_ref3) {
	  var ids = _ref3.ids,
	      versions = _ref3.versions,
	      dependencyIds = _ref3.dependencyIds,
	      loaded = _ref3.loaded;
	...
	var DependencyMatrix$1 = connect(mapStateToProps$1)(DependencyMatrix);
	...
	var ScopeFilter$1 = connect(mapStateToProps$2, mapDispatchToProps$2)(ScopeFilter);
	...
	var App$1 = connect(mapStateToProps$3, mapDispatchToProps$3)(App);
