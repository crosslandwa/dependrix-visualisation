(function () {
	...
	*/
	...
	var react_8 = react.useLayoutEffect;
	...
	function Provider(_ref) {
	  ...
	  var contextValue = react_9(function () {
	  ...
	  var previousState = react_9(function () {
	...
	var reactIs_1 = reactIs.isContextConsumer;
	...
	var useIsomorphicLayoutEffect = isHopefullyDomEnvironment ? react_8 : react_7;
	...
	*/
	...
	_ref) {
	  ...
	  return function wrapWithConnect(WrappedComponent) {
	    ...
	    var usePureOnlyMemo = pure ? react_9 : function (callback) {
	      return callback();
	    };

	    function ConnectFunction(props) {
	      var _useMemo = react_9(function () {
	      ...
	      var ContextToUse = react_9(function () {
	      ...
	      var contextValue = react_6(ContextToUse); // The store _must_ exist as either a prop or in context.
	      ...
	      var childPropsSelector = react_9(function () {
	        // The child props selector needs the store reference as an input.
	        // Re-create this selector whenever the store changes.
	        return createChildSelector(store);
	      }, [store]);

	      var _useMemo2 = react_9(function () {
	      ...
	      var overriddenContextValue = react_9(function () {
	      ...
	      var renderedWrappedComponent = react_9(function () {
	      ...
	      var renderedChild = react_9(function () {
	...
	var css = ".container {\n  font-family: sans-serif;\n  margin-left: 1em;\n  margin-right: 1em;\n}\n\n.header--xl {\n  margin-top: 0\n}\n\n.load-summary {\n  color: #444;\n  margin-top: 1em;\n  padding: 1em;\n}\n\n.load-summary--error {\n  background: pink;\n  border-color: red;\n  border-style: solid;\n  border-width: 1px;\n}\n\n.load-summary__spinner {\n  animation: rotate-360 1.2s cubic-bezier(0, 0, 1, 1) infinite;\n  border-color: #444 #444 #444 transparent;\n  border-radius: 50%;\n  border-style: solid;\n  border-width: 0.5em;\n  height: 2em;\n  margin: 0.75em;\n  width: 2em;\n}\n\n@keyframes  rotate-360 {\n  0% {\n    transform: rotate(0deg);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n}\n\n.details__reveal {\n  border-left: solid 5px gray;\n  margin-top: 1em;\n  padding: 0 1em;\n}\n\n.matrix__table {\n  border-spacing: 0;\n  font-size: 0.8em;\n}\n\n.matrix__table-wrapper {\n  width: fit-content;\n  max-width: 100%;\n  overflow: scroll;\n  max-height: 35em;\n  border: solid 1px gray;\n  margin-top: 1em;\n}\n\n.matrix__table-cell {\n  border: solid 1px lightgray;\n  height: 5em;\n  min-width: 10em;\n  max-width: 10em;\n  overflow-wrap: break-word;\n  text-align: center;\n}\n\n.matrix__dependency-detail {\n  margin: 0.25em 0;\n}\n\n.matrix__table-cell-label {\n  display: block;\n}\n\n.matrix__table-cell-divide {\n  margin: 0 1em;\n}\n\n.matrix__table-cell-label--major::before {\n  content: 'M: ';\n}\n\n.matrix__table-cell-label--major {\n  box-shadow: inset 0em 0em 1em 0px red;\n  border-radius: 1em;\n}\n\n.matrix__table-cell-label--minor::before {\n  content: 'm: ';\n}\n\n.matrix__table-cell-label--minor {\n  box-shadow: inset 0em 0em 1em 0px orange;\n  border-radius: 1em;\n}\n\n.matrix__table-cell-label--patch::before {\n  content: 'p: ';\n}\n\n.matrix__table-cell-label--patch {\n  box-shadow: inset 0em 0em 1em 0px yellow;\n  border-radius: 1em;\n}\n\n.matrix__table-cell--lh-column {\n  position: sticky;\n  left: 0;\n  background: white;\n  font-weight: bold;\n  border-right: solid 2px gray;\n}\n\n.matrix__table-cell--header {\n  position: sticky;\n  top: 0;\n  background: white;\n  font-weight: bold;\n  border-bottom: solid 2px gray\n}\n\n.matrix__table-cell--overview {\n  position: sticky;\n  top: 0;\n  left: 0;\n  background: lightgray;\n  border-right: solid 2px gray;\n  border-bottom: solid 2px gray;\n  z-index: 1;\n}\n\n.input-label {\n  display: block;\n  margin-top: 0.5em;\n  margin-bottom: 0.25em;\n}\n\n.input-text {\n  width: 100%;\n}\n\n.checkbox-group__fieldset {\n  border: none;\n  padding: 0;\n  margin: 0;\n  margin-top: 0.5em;\n}\n\n.checkbox-group__legend {\n  margin-bottom: 0.25em;\n}\n\n.checkbox-group__label {\n  margin-left: 0.25em;\n  margin-right: 1em;\n}\n";
	styleInject(css);
	...
	var makeGETRequest = function makeGETRequest(url) {
	  ...
	  return new Promise(function (resolve, reject) {
	    return browserRequest.get({
	      url: url,
	      headers: headers
	    }, function (error, response, body) {
	      return error || response.statusCode >= 400 || response.statusCode < 200 ? reject(new Error(error || "Failed request for ".concat(url))) : resolve(body);
	    });
	  });
	};

	var newerOf = function newerOf(a, b) {
	  var versionA = parse(a);
	  var versionB = parse(b);
	  return isNewerMajor(versionA, versionB) || isNewerMinor(versionA, versionB) || isNewerPatch(versionA, versionB) ? a : b;
	};

	var parse = function parse(version) {
	  var _map = (version && version.match(/\d+/g) || []).map(Number),
	      _map2 = _slicedToArray(_map, 3),
	      _map2$ = _map2[0],
	      major = _map2$ === void 0 ? 0 : _map2$,
	      _map2$2 = _map2[1],
	      minor = _map2$2 === void 0 ? 0 : _map2$2,
	      _map2$3 = _map2[2],
	      patch = _map2$3 === void 0 ? 0 : _map2$3;
	...
	var isNewerMajor = function isNewerMajor(a, b) {
	  return a.major > b.major;
	};

	var isNewerMinor = function isNewerMinor(a, b) {
	  return a.major === b.major && a.minor > b.minor;
	};

	var isNewerPatch = function isNewerPatch(a, b) {
	  return a.major === b.major && a.minor === b.minor && a.patch > b.patch;
	};

	var versionLag = function versionLag(test, latest) {
	  var testVersion = parse(test);
	...
	var apply = function apply(x, f) {
	  return f(x);
	};

	var uniques = function uniques() {
	  var arr = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
	  return _toConsumableArray(new Set(arr));
	};

	var passAlways = function passAlways() {
	  return true;
	}; // ------ ACTIONS ------
	...
	var treeLoadedSuccessfully = function treeLoadedSuccessfully(data) {
	  return {
	...
	var treeLoadFailed = function treeLoadFailed() {
	  return {
	    type: 'TREE_LOAD_FAILED'
	  };
	};

	var updateProjectFilter = function updateProjectFilter(search) {
	  return {
	    type: 'UPDATE_PROJECT_FILTER',
	    search: sanitiseSearch(search)
	  };
	};
	var updateLibraryFilter = function updateLibraryFilter(search) {
	  return {
	    type: 'UPDATE_LIBRARY_FILTER',
	    search: sanitiseSearch(search)
	  };
	};
	var updateDependencyScopeFilter = function updateDependencyScopeFilter() {
	  var selectedScopes = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
	  return {
	    type: 'UPDATE_DEPENDENCY_SCOPE_FILTER',
	    selectedScopes: selectedScopes
	  };
	};
	var updateVersionLagFilter = function updateVersionLagFilter() {
	  var selectedVersionLags = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
	  return {
	    type: 'UPDATE_VERSION_LAG_FILTER',
	    selectedVersionLags: selectedVersionLags
	  };
	};

	var sanitiseSearch = function sanitiseSearch(search) {
	  return search.toLowerCase().split(',').map(function (x) {
	    return x.trim();
	  }).filter(function (x) {
	    return x;
	  });
	...
	var hasTreeLoadBeenAttempted = function hasTreeLoadBeenAttempted(state) {
	  return !!state.tree.loadStatus;
	};
	var hasTreeLoadedSuccessfully = function hasTreeLoadedSuccessfully(state) {
	  return state.tree.loadStatus === 'success';
	};
	var analysisTitle = function analysisTitle(state) {
	  return state.analysis.title;
	};
	var filteredProjectIds = function filteredProjectIds(state) {
	  return Object.keys(state.projects).filter(isProjectAllowedByFilters(state)).sort();
	};
	var projectVersion = function projectVersion(state, projectId) {
	  return state.projects[projectId].version;
	};

	var projectDependencies = function projectDependencies(state, projectId) {
	  return state.projects[projectId].dependencies;
	};

	var filteredDependencyMap = function filteredDependencyMap(state, projectIds) {
	  var dependencyFilter = isDependencyAllowedByFilters(state);
	  return projectIds.reduce(function (acc, projectId) {
	    return _objectSpread2$1({}, acc, _defineProperty$1({}, projectId, projectDependencies(state, projectId).reduce(function (filtered, dependency) {
	      return _objectSpread2$1({}, filtered, _defineProperty$1({}, dependency.id, (filtered[dependency.id] || []).concat([dependency].filter(dependencyFilter))));
	    }, {})));
	  }, {});
	};
	var latestLibraryVersions = function latestLibraryVersions(state) {
	  return state.latestLibraryVersions;
	};
	var availableVersionLags = function availableVersionLags(state) {
	  return ['major', 'minor', 'patch'];
	};
	var availableScopes = function availableScopes(state) {
	  return state.dependencyScopes;
	};
	var filteredLibraryIds = function filteredLibraryIds(state, projectIds) {
	  var libFilter = isDependencyAllowedByFilters(state);
	  return projectIds.reduce(function (acc, projectId) {
	    return uniques(acc.concat(projectDependencies(state, projectId).filter(libFilter).map(function (dependency) {
	      return dependency.id;
	    })));
	  }, []).sort();
	};

	var isProjectAllowedByFilters = function isProjectAllowedByFilters(state) {
	  var bySearch = bySearchTerms(state.filters.projectSearch);
	  var dependencyFiltersActive = !!(state.filters.librarySearch.length || state.filters.selectedScopes.length || state.filters.selectedVersionLags.length);
	  var byDependencies = dependencyFiltersActive ? function (projectId) {
	    return projectDependencies(state, projectId).some(isDependencyAllowedByFilters(state));
	  } : passAlways;
	  return function (projectId) {
	    return bySearch(projectId) && byDependencies(projectId);
	  };
	};

	var isDependencyAllowedByFilters = function isDependencyAllowedByFilters(state) {
	  var bySearch = bySearchTerms(state.filters.librarySearch);
	  var byScope = state.filters.selectedScopes.length ? function (scope) {
	    return state.filters.selectedScopes.includes(scope);
	  } : passAlways;
	  var byVersionLag = state.filters.selectedVersionLags.length ? function (versionLag) {
	    return state.filters.selectedVersionLags.includes(versionLag);
	  } : passAlways;
	  return function (dependency) {
	    return bySearch(dependency.id) && byScope(dependency.scope) && byVersionLag(dependency.versionLag);
	  };
	};

	var bySearchTerms = function bySearchTerms(filters) {
	  return filters.length ? function (id) {
	    return filters.some(function (term) {
	...
	var treeLoadReducer = function treeLoadReducer() {
	...
	var projectsReducer = function projectsReducer() {
	  ...
	  switch (action.type) {
	    case 'TREE_LOAD_SUCCESS':
	      return Object.keys(action.data.projects).reduce(function (acc, projectId) {
	        return _objectSpread2$1({}, acc, _defineProperty$1({}, projectId, {
	          version: action.data.projects[projectId].version,
	          dependencies: action.data.projects[projectId].dependencies.map(function (_ref) {
	            var id = _ref.id,
	...
	var dependencyScopesReducer = function dependencyScopesReducer() {
	  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
	  var action = arguments.length > 1 ? arguments[1] : undefined;
	...
	var latestLibraryVersionsReducer = function latestLibraryVersionsReducer() {
	  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
	  var action = arguments.length > 1 ? arguments[1] : undefined;
	...
	var filtersReducer = function filtersReducer() {
	  ...
	  switch (action.type) {
	    ...
	    case 'UPDATE_LIBRARY_FILTER':
	      return _objectSpread2$1({}, state, {
	        librarySearch: action.search
	      });

	    case 'UPDATE_DEPENDENCY_SCOPE_FILTER':
	      return _objectSpread2$1({}, state, {
	        selectedScopes: action.selectedScopes
	      });

	    case 'UPDATE_VERSION_LAG_FILTER':
	      return _objectSpread2$1({}, state, {
	        selectedVersionLags: action.selectedVersionLags
	      });
	  }
	...
	var analysisReducer = function analysisReducer() {
	  ...
	  switch (action.type) {
	    case 'TREE_LOAD_SUCCESS':
	      return action.data.analysis ? {
	        title: action.data.analysis.title
	      } : state;
	  }
	...
	function treeLoadMiddleware(store) {
	  return function (next) {
	    return function (action) {
	      switch (action.type) {
	        case 'LOAD_TREE':
	          var dispatchLoadedTree = function dispatchLoadedTree(data) {
	          ...
	          var dispatchLoadFailure = function dispatchLoadFailure(error) {
	            console.error(error.message);
	            next(treeLoadFailed());
	          };

	          return new Promise(function (resolve, reject) {
	            return apply(document.getElementById('modelled-dependencies'), function (element) {
	              return element ? resolve(JSON.parse(element.innerHTML)) : reject(new Error('Could not find modelled-dependencies in DOM'));
	            });
	          })["catch"](function (e) {
	            return makeGETRequest('modelled-dependencies.json').then(JSON.parse);
	          }) // load from server if not in DOM
	...
	var parseScopes = function parseScopes(data) {
	  return Object.keys(data.projects).reduce(function (acc, projectId) {
	    return uniques(acc.concat(data.projects[projectId].dependencies.map(function (dependency) {
	...
	var parseLatestLibraryVersions = function parseLatestLibraryVersions(data) {
	  return Object.keys(data.projects).reduce(function (latestVersions, projectId) {
	    return data.projects[projectId].dependencies.reduce(function (acc, _ref2) {
	      var id = _ref2.id,
	          version = _ref2.version;
	      return _objectSpread2$1({}, acc, _defineProperty$1({}, id, newerOf(acc[id], version)));
	    }, latestVersions);
	  }, {});
	};
	...
	var Initialising = function Initialising() {
	  return react.createElement("div", {
	    "class": "load-summary"
	  }, react.createElement("span", null, "Initialising..."), react.createElement("div", {
	    "class": "load-summary__spinner"
	  }));
	};

	var LoadFailed = function LoadFailed() {
	  return react.createElement("div", {
	    "class": "load-summary load-summary--error"
	  }, "Tree load failed");
	};

	var LoadSummary = function LoadSummary(_ref) {
	  var loadAttempted = _ref.loadAttempted;
	  return loadAttempted ? react.createElement(LoadFailed, null) : react.createElement(Initialising, null);
	};

	var LoadSummary$1 = connect(mapStateToProps)(LoadSummary);

	var DependencyCell = function DependencyCell(_ref) {
	  var dependencies = _ref.dependencies;
	  return react.createElement("td", {
	    "class": "matrix__table-cell"
	  }, dependencies.map(function (_ref2) {
	    var scope = _ref2.scope,
	        version = _ref2.version,
	        versionLag = _ref2.versionLag;
	    return react.createElement("div", {
	      "class": "matrix__dependency-detail"
	    }, react.createElement("span", {
	      "class": "matrix__table-cell-label".concat(versionLag ? " matrix__table-cell-label--".concat(versionLag) : '')
	    }, version), scope && react.createElement("span", {
	      "class": "matrix__table-cell-label"
	    }, scope));
	  }).reduce(function (a, b) {
	    return a ? [a, react.createElement("hr", {
	      "class": "matrix__table-cell-divide"
	    }), b] : [b];
	  }, null));
	};
	...
	var ProjectCell = function ProjectCell(_ref2) {
	  var projectId = _ref2.projectId,
	      version = _ref2.version;
	  return react.createElement("td", {
	    "class": "matrix__table-cell matrix__table-cell--header"
	  }, react.createElement("span", {
	    "class": "matrix__table-cell-label"
	  }, projectId), react.createElement("span", {
	    "class": "matrix__table-cell-label"
	  }, version));
	};

	var ProjectCell$1 = connect(mapStateToProps$1)(ProjectCell);

	var mapStateToProps$2 = function mapStateToProps(state) {
	  var projectIds = filteredProjectIds(state);
	  return {
	...
	var DependencyMatrix = function DependencyMatrix(_ref) {
	  var projectIds = _ref.projectIds,
	      libraryIds = _ref.libraryIds,
	      dependencyMap = _ref.dependencyMap,
	      latestLibraryVersions = _ref.latestLibraryVersions;
	  return react.createElement("div", {
	    "class": "matrix__table-wrapper"
	  }, react.createElement("table", {
	    "class": "matrix__table"
	  }, react.createElement("thead", null, react.createElement("tr", null, react.createElement("td", {
	    "class": "matrix__table-cell matrix__table-cell--overview"
	  }, react.createElement("span", {
	    "class": "matrix__table-cell-label"
	  }, projectIds.length, " projects"), react.createElement("span", {
	    "class": "matrix__table-cell-label"
	  }, libraryIds.length, " libraries")), projectIds.map(function (projectId) {
	    return react.createElement(ProjectCell$1, {
	      projectId: projectId
	    });
	  }))), react.createElement("tbody", null, libraryIds.map(function (libraryId) {
	    return react.createElement("tr", null, react.createElement("td", {
	      "class": "matrix__table-cell matrix__table-cell--lh-column"
	    }, react.createElement("span", {
	      "class": "matrix__table-cell-label"
	    }, libraryId), react.createElement("span", {
	      "class": "matrix__table-cell-label"
	    }, "(latest: ", latestLibraryVersions[libraryId], ")")), projectIds.map(function (projectId) {
	      return react.createElement(DependencyCell, {
	        dependencies: dependencyMap[projectId][libraryId] || []
	      });
	    }));
	  }))));
	};

	var DependencyMatrix$1 = connect(mapStateToProps$2)(DependencyMatrix);

	var debouncedEventValue = function debouncedEventValue(timeout, fn) {
	  var timer;
	  return function (e) {
	    clearTimeout(timer);
	...
	var debounced = function debounced(timeout, fn) {
	  var timer;
	  return function () {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    update: debouncedEventValue(500, function (value) {
	      return dispatch(updateLibraryFilter(value));
	    })
	  };
	};

	var LibraryFilter = function LibraryFilter(_ref) {
	  var update = _ref.update;
	  return react.createElement(react.Fragment, null, react.createElement("label", {
	    "class": "input-label",
	    "for": "libraryFilter"
	  }, "Filter libraries"), react.createElement("input", {
	    id: "libraryFilter",
	    type: "text",
	    "class": "input-text",
	...
	var LibraryFilter$1 = connect(undefined, mapDispatchToProps)(LibraryFilter);

	var mapDispatchToProps$1 = function mapDispatchToProps(dispatch) {
	  return {
	    update: debouncedEventValue(500, function (value) {
	      return dispatch(updateProjectFilter(value));
	    })
	  };
	};

	var ProjectFilter = function ProjectFilter(_ref) {
	  var update = _ref.update;
	  return react.createElement(react.Fragment, null, react.createElement("label", {
	    "class": "input-label",
	    "for": "projectFilter"
	  }, "Filter projects"), react.createElement("input", {
	    id: "projectFilter",
	    type: "text",
	    "class": "input-text",
	...
	var ProjectFilter$1 = connect(undefined, mapDispatchToProps$1)(ProjectFilter);
	...
	var mapDispatchToProps$2 = function mapDispatchToProps(dispatch) {
	  return {
	    update: debounced(500, function (value) {
	      return dispatch(updateDependencyScopeFilter(value));
	    })
	  };
	};
	...
	function (_React$Component) {
	  _inherits(ScopeFilter, _React$Component);

	  function ScopeFilter(props) {
	    var _this;

	    _classCallCheck(this, ScopeFilter);

	    _this = _possibleConstructorReturn(this, _getPrototypeOf(ScopeFilter).call(this, props));
	    _this.state = {
	      selectedScopes: []
	    };
	    ...
	    _this.update = function (e) {
	      ...
	      _this.setState(function (state) {
	        var selectedScopes = state.selectedScopes.includes(value) ? state.selectedScopes.filter(function (scope) {
	          return scope !== value;
	  ...
	  _createClass(ScopeFilter, [{
	    key: "render",
	    value: function render() {
	      var _this2 = this;

	      var availableScopes = this.props.availableScopes;
	      return react.createElement("fieldset", {
	        "class": "checkbox-group__fieldset"
	      }, react.createElement("legend", {
	        "class": "checkbox-group__legend"
	      }, "Filter by scope"), react.createElement("div", null, availableScopes.map(function (scope) {
	...
	var ScopeFilter$1 = connect(mapStateToProps$3, mapDispatchToProps$2)(ScopeFilter);

	var mapStateToProps$4 = function mapStateToProps(state) {
	  return {
	    availableVersionLags: availableVersionLags()
	  };
	};
	...
	var mapDispatchToProps$3 = function mapDispatchToProps(dispatch) {
	  return {
	    update: debounced(500, function (value) {
	      return dispatch(updateVersionLagFilter(value));
	    })
	  };
	};

	var VersionLagFilter =
	/*#__PURE__*/
	function (_React$Component) {
	  _inherits(VersionLagFilter, _React$Component);

	  function VersionLagFilter(props) {
	    var _this;

	    _classCallCheck(this, VersionLagFilter);

	    _this = _possibleConstructorReturn(this, _getPrototypeOf(VersionLagFilter).call(this, props));
	    _this.state = {
	      selectedVersionLags: []
	    };
	    ...
	    _this.update = function (e) {
	      ...
	      _this.setState(function (state) {
	        var selectedVersionLags = state.selectedVersionLags.includes(value) ? state.selectedVersionLags.filter(function (lag) {
	          return lag !== value;
	  ...
	  _createClass(VersionLagFilter, [{
	    key: "render",
	    value: function render() {
	      var _this2 = this;

	      var availableVersionLags = this.props.availableVersionLags;
	      return react.createElement("fieldset", {
	        "class": "checkbox-group__fieldset"
	      }, react.createElement("legend", {
	        "class": "checkbox-group__legend"
	      }, "Filter by version lag"), react.createElement("div", null, availableVersionLags.map(function (lag) {
	        return react.createElement(react.Fragment, null, react.createElement("input", {
	          "class": "checkbox-group__input",
	          id: lag,
	          name: "versionLag",
	  ...
	  return VersionLagFilter;
	}(react.Component);

	var VersionLagFilter$1 = connect(mapStateToProps$4, mapDispatchToProps$3)(VersionLagFilter);

	var Filters = function Filters(_ref) {
	  var dependenciesLoaded = _ref.dependenciesLoaded;
	  return react.createElement("details", {
	    "class": "details",
	    open: !!dependenciesLoaded
	  }, react.createElement("summary", {
	    "class": "details__summary"
	  }, "Filters"), react.createElement("div", {
	    "class": "details__reveal"
	  }, react.createElement(ProjectFilter$1, null), react.createElement(LibraryFilter$1, null), react.createElement(ScopeFilter$1, null), react.createElement(VersionLagFilter$1, null)));
	};
	...
	var PageTitle$1 = connect(mapStateToProps$5)(PageTitle);
	...
	var App = function App(_ref) {
	  var loaded = _ref.loaded;
	  return react.createElement(react.Fragment, null, react.createElement(PageTitle$1, null), react.createElement(Filters, {
	    dependenciesLoaded: loaded
	  }), !loaded && react.createElement(LoadSummary$1, null), loaded && react.createElement(DependencyMatrix$1, null));
	};

	var App$1 = connect(mapStateToProps$6)(App);

	var reducer = combineReducers({
	  analysis: analysisReducer,
	  dependencyScopes: dependencyScopesReducer,
	  latestLibraryVersions: latestLibraryVersionsReducer,
	  projects: projectsReducer,
	  filters: filtersReducer,
	  tree: treeLoadReducer
	});
	var composeEnhancers = window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ || compose;

	function createAppStore() {
	  var middlewares = [treeLoadMiddleware];
	  return createStore(reducer, composeEnhancers(applyMiddleware.apply(void 0, middlewares)));
	}

	var store = createAppStore();
	reactDom.render(react.createElement(Provider, {
	  store: store
	}, react.createElement(App$1, null)), document.getElementById('app'));
